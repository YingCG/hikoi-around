        ...
        <>
            ...
            <h3>10 mins walk</h3>
                <p>
                    ...
                    For starters, we’ve known that walking helps improve oxygen flow to the brain. This may also positively impacts your mood and mental health.
                </p>

                <ul>
                    <li>Getting Fresh Air</li>
                    <li>Improved Concentration</li>
                    <li>Increased Vitamin D</li>
